...
export declare function createLongDescription(value: string, label: string, required?: boolean, language?: string, ...customValidators: GenericValidation[]): LongDescription;
