...
class KebabCode extends Types_1.GenericType {
    constructor(value, label = null, ...customValidators) {
        ...
        const defaultValidators = [
            () => (0, Validations_1.CannotBeBlank)(formatedValue, msg),
            ...
            () => (0, Validations_1.RegexMatch)(formatedValue, '^[a-z0-9]+(-[a-z0-9]+)*$', 'must contain only letters, numbers or non-consecutive dashes', 'kebab code'),
        ];
